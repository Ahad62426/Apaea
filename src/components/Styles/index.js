...
export const TColors = { primaryColor: "#0E3968", bgColorPrimary: "#0E3968", bgSecondary: "#1C4E85", lightGray: "#B9C9DA" };
...
export default {
  ...
  inputBgColor: {
    backgroundColor: "#81A2DA",
    borderWidth: 0
  },
  //Borders
  noBorder: {
    borderTopWidth: 0, borderBottomWidth: 0, borderWidth: 0, borderRightWidth: 0, borderLeftWidth: 0,
  },
